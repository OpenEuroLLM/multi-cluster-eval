...
class TestInteractiveCSVBuilder:
    ...
    def test_basic_csv_creation(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_multiple_models_and_tasks(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_custom_n_shot_values(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_local_path_model(self, mock_confirm, mock_text, mock_path, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_user_cancellation(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_no_save_confirmation(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_invalid_n_shot_values(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    @patch("oellm.interactive_csv_builder.questionary.text")
    @patch("oellm.interactive_csv_builder.questionary.confirm")
    def test_view_current_models_and_tasks(self, mock_confirm, mock_text, mock_select, temp_output_path):
    ...
    def test_output_directory_creation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("oellm.interactive_csv_builder.questionary.select") as mock_select, \
                 patch("oellm.interactive_csv_builder.questionary.text") as mock_text, \
                 patch("oellm.interactive_csv_builder.questionary.confirm") as mock_confirm:
